...
<div class="row" id="orderCreateApp" v-cloak>
    <form class="px-2 col-12 px-md-3" v-on:submit.prevent="onSubmit">
        <div class="bgc-white p-3 border mb-4">
            ...
            <div class="row mx-0">
                <div class="col-12 mb-3" v-for="(caseItem, caseIndex) in order.cases">
                    <div class="row">
        ...
        <a href="{{ route('order.index')}}" class="btn btn-secondary float-right mb-3">{{ __('order.functional.cancel') }}</a>
    </form>
</div>
@endsection
